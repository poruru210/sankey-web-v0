    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex relative">
          ...
          <main className="flex-1 container mx-auto px-4 py-8 pb-12 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              <Card className="bg-slate-800/60 border-emerald-500/20 backdrop-blur-sm">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-white">{filteredPendingApplications.length}</div>
              ...
              <Card className="bg-slate-800/60 border-emerald-500/20 backdrop-blur-sm">
                ...
                <CardContent>
                  <div className="text-2xl font-bold text-white">{filteredApprovedLicenses.length}</div>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className={`grid gap-4 ${isMobile ? "grid-cols-1" : "grid-cols-1 md:grid-cols-5"}`}>
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-emerald-200">Account Number</label>
                    ...
                    {isMobile && (
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-emerald-200 opacity-0">Advanced</label>
                        <Button
                          variant="outline"
                    ...
                    {(!isMobile || showAdvancedFilters) && (
                      <>
                        {/* EA Name Filter */}
                        <div className="space-y-2">
                          <label className="text-sm font-medium text-emerald-200">EA Name</label>
                          <div className="relative">
                        ...
                        {/* Broker Filter */}
                        <div className="space-y-2">
                          <label className="text-sm font-medium text-emerald-200">Broker</label>
                          <select
                            value={brokerFilter}
                        ...
                        {/* X Account Filter */}
                        <div className="space-y-2">
                          <label className="text-sm font-medium text-emerald-200">X Account</label>
                          <div className="relative">
                    ...
                    {(!isMobile || showAdvancedFilters) && (
                      <div className="space-y-2">
                        <label className="text-sm font-medium text-emerald-200 opacity-0">Clear</label>
                        <Button
                          variant="outline"
            ...
            <Tabs defaultValue="pending" className="w-full">
              <TabsList className="grid w-full grid-cols-3 bg-slate-800/50 border border-emerald-500/20 p-1 rounded-lg overflow-hidden">
                <TabsTrigger
                  value="pending"
                    ...
                    <div className="space-y-4">
                      {paginatedPendingApplications.map((app) => (
                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm text-emerald-200/70">
                            <div>
                              <span className="text-emerald-300">Account:</span> {app.accountNumber}
                            </div>
                            <div>
                              <span className="text-emerald-300">Broker:</span> {app.broker}
                            </div>
                            ...
                            <div>
                              <span className="text-emerald-300">Applied:</span> {app.appliedAt}
                            </div>
                            <div>
                        ...
                        >
                          <div className="flex flex-col space-y-3 mb-4 sm:flex-row sm:items-center sm:justify-between sm:space-y-0">
                            <div className="flex items-center space-x-3">
                              ...
                              <Badge className="bg-emerald-500 hover:bg-emerald-600 text-white">{license.status}</Badge>
                            </div>
                            <div className="flex space-x-2">
                              <Button
                                size="sm"
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm text-emerald-200/70 mb-3">
                            <div>
                              <span className="text-emerald-300">Account:</span> {license.accountNumber}
                            </div>
                            <div>
                              <span className="text-emerald-300">Broker:</span> {license.broker}
                            </div>
                            <div className="flex items-center">
                              <Mail className="w-3 h-3 mr-1" />
                              {license.email}
                            ...
                            <div>
                              <span className="text-emerald-300">Approved:</span> {license.approvedAt}
                            </div>
                            <div>
                              <span className="text-emerald-300">Expires:</span> {license.expiresAt}
                            </div>
                          </div>
                          <div className="flex items-center space-x-2 mt-3">
                            <code className="text-xs bg-slate-800/70 px-2 py-1 rounded text-emerald-100 font-mono border border-emerald-500/20 flex-1">
                    ...
                    <div className="space-y-4">
                      {paginatedLicenseHistory.map((history) => (
                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm text-emerald-200/70 mb-3">
                            <div>
                              <span className="text-emerald-300">Account:</span> {history.accountNumber}
                            </div>
                            <div>
                              <span className="text-emerald-300">Broker:</span> {history.broker}
                            </div>
                            <div className="flex items-center">
                              <Mail className="w-3 h-3 mr-1" />
                              {history.email}
                            ...
                            <div>
                              <span className="text-emerald-300">Issued:</span> {history.issuedAt}
                            </div>
                            <div>
              ...
              <Card className="bg-slate-800/60 border-emerald-500/20 backdrop-blur-sm">
                ...
                <CardContent>
                  ...
                  <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10 mb-6">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        <div className="flex items-center justify-center w-10 h-10 bg-emerald-500/10 rounded-lg border border-emerald-400/20">
                          <Key className="w-5 h-5 text-emerald-400" />
                        </div>
                        <div>
                          <h3 className="text-lg font-semibold text-white">Basic Plan</h3>
                          <p className="text-sm text-emerald-200/70">Great for small businesses</p>
                        </div>
                      </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="text-sm font-medium text-emerald-200">Monthly Licenses</h4>
                    ...
                    <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="text-sm font-medium text-emerald-200">Active Licenses</h4>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10">
                      ...
                      <p className="text-sm text-emerald-200/70 mb-3">Windows DLL for license verification functions</p>
                      <Button
                        size="sm"
                        className="w-full bg-emerald-500 hover:bg-emerald-600 text-white focus:text-white focus:bg-emerald-600"
                      >
                    ...
                    <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10">
                      ...
                      <p className="text-sm text-emerald-200/70 mb-3">Complete API reference and examples</p>
                      <Button
                        size="sm"
                        variant="outline"
        ...
        <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
          ...
          >
            {isMobile ? (
              ...
              <div className="flex flex-col h-full">
                {/* Mobile Header */}
                <div className="flex items-center justify-between p-4 border-b border-emerald-500/20 flex-shrink-0">
                  <div className="flex items-center">
                    <Settings className="w-5 h-5 mr-2 text-emerald-400" />
                ...
                >
                  <div className="space-y-6 pb-4">
                    <p className="text-emerald-200/60 text-sm">Configure your dashboard preferences</p>

                    <div className="space-y-6">
                      <div className="space-y-3">
                        <label className="text-sm font-medium text-emerald-200">Items per page</label>
                        <Select value={itemsPerPage.toString()} onValueChange={(value) => setItemsPerPage(Number(value))}>
                          <SelectTrigger className="bg-slate-900/50 border-emerald-500/20 text-white h-12">
                            <SelectValue />
                          </SelectTrigger>
                        ...
                        <p className="text-xs text-emerald-200/60">Number of items to display per page in tables</p>
                      </div>

                      <div className="space-y-3">
                        <label className="text-sm font-medium text-emerald-200">Theme Preference</label>
                        <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10">
                          <p className="text-xs text-emerald-200/60 mb-2">Theme settings are available in the header</p>
                          <div className="flex space-x-2">
                            <div className="w-6 h-6 bg-slate-700 rounded border border-emerald-500/20"></div>
                            <div className="w-6 h-6 bg-white rounded border border-emerald-500/20"></div>
                            <div className="w-6 h-6 bg-emerald-500 rounded border border-emerald-500/20"></div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10">
                          <p className="text-xs text-emerald-200/60 mb-2">Language settings are available in the header</p>
                          <div className="text-sm text-emerald-300">Current: English (US)</div>
                        </div>
                      </div>

                      <div className="space-y-3">
                        <label className="text-sm font-medium text-emerald-200">Notifications</label>
                        <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10 space-y-3">
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-emerald-200">Email notifications</span>
                            <div className="w-10 h-6 bg-emerald-500 rounded-full relative">
                              <div className="w-4 h-4 bg-white rounded-full absolute top-1 right-1"></div>
                            </div>
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-emerald-200">Push notifications</span>
                            <div className="w-10 h-6 bg-slate-600 rounded-full relative">
                              <div className="w-4 h-4 bg-white rounded-full absolute top-1 left-1"></div>
                            </div>
                          </div>
                          <p className="text-xs text-emerald-200/60">Get notified about license events and updates</p>
                        </div>
                      </div>

                      <div className="space-y-3">
                        <label className="text-sm font-medium text-emerald-200">Auto-refresh</label>
                        <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10 space-y-3">
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-emerald-200">Enable auto-refresh</span>
                            <div className="w-10 h-6 bg-emerald-500 rounded-full relative">
                              <div className="w-4 h-4 bg-white rounded-full absolute top-1 right-1"></div>
                            </div>
                          </div>
                          <div className="space-y-2">
                            <span className="text-sm text-emerald-200">Refresh interval</span>
                            <select className="w-full px-3 py-2 bg-slate-800 border border-emerald-500/20 rounded-md text-white text-sm">
                          ...
                          <p className="text-xs text-emerald-200/60">Automatically refresh dashboard data at specified intervals</p>
                        </div>
                      </div>

                      <div className="space-y-3">
                        <label className="text-sm font-medium text-emerald-200">Export Options</label>
                        <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10 space-y-3">
                          <div className="grid grid-cols-2 gap-2">
                            <button className="p-2 bg-slate-800 border border-emerald-500/20 rounded text-sm text-emerald-200 hover:bg-emerald-500/20">
                              Export CSV
                            </button>
                            <button className="p-2 bg-slate-800 border border-emerald-500/20 rounded text-sm text-emerald-200 hover:bg-emerald-500/20">
                              Export PDF
                          ...
                          <p className="text-xs text-emerald-200/60">Configure data export preferences and formats</p>
                        </div>
                      </div>

              <div className="space-y-3">
                <label className="text-sm font-medium text-emerald-200">Security Settings</label>
                <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10 space-y-3">
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-emerald-200">Session timeout</span>
                    <select className="px-2 py-1 bg-slate-800 border border-emerald-500/20 rounded text-white text-sm">
                  ...
                  <p className="text-xs text-emerald-200/60">Enhanced security options for your account</p>
                </div>
              </div>

              <div className="space-y-3">
                <label className="text-sm font-medium text-emerald-200">Display Settings</label>
                <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10 space-y-3">
                  <div className="space-y-2">
                  ...
                  <p className="text-xs text-emerald-200/60">Customize how dates and times are displayed</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSettingsSave} className="bg-emerald-500 hover:bg-emerald-600 text-white">
            Save Settings
          </Button>
        </DialogFooter>
      </>
          ...
          >
            {isMobile ? (
              ...
              <div className="flex flex-col h-full">
                ...
                >
                  <div className="space-y-6 pb-4">
                    <p className="text-emerald-200/60 text-sm">Choose the plan that best fits your needs</p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/20">
                        <div className="flex items-center justify-between mb-3">
                          <div>
                            <h3 className="text-lg font-semibold text-white">Basic Plan</h3>
                            <p className="text-sm text-emerald-200/70">Perfect for small businesses</p>
                          </div>
                      ...
                      <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10">
                        <div className="flex items-center justify-between mb-3">
                          <div>
                            ...
                            <p className="text-sm text-emerald-200/70">For growing businesses</p>
                          </div>
                          <Badge variant="outline" className="border-emerald-500 text-emerald-400">Upgrade</Badge>
                        </div>
                        <div className="space-y-2 text-sm text-emerald-200/70">
                      ...
                      <div className="p-4 bg-slate-900/40 rounded-lg border border-emerald-500/10">
                        <div className="flex items-center justify-between mb-3">
                          <div>
                            ...
                            <p className="text-sm text-emerald-200/70">For large organizations</p>
                          </div>
                          <Badge variant="outline" className="border-emerald-500 text-emerald-400">Contact</Badge>
                        </div>
                        <div className="space-y-2 text-sm text-emerald-200/70">
